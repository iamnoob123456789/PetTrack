...
// Enhanced version with auto-resize and focus effects
class EnhancedTextarea extends StatefulWidget {
  final String? placeholder;
  final TextEditingController? controller;
  final ValueChanged<String>? onChanged;
  final bool enabled;
  ...
  @override
  State<EnhancedTextarea> createState() => _EnhancedTextareaState();
}

class _EnhancedTextareaState extends State<EnhancedTextarea> {
